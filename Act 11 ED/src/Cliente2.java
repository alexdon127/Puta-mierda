...
@version: 01/12/2017
*/
public class Cliente2 extends Object {
	...
	*/
	public Cliente2(int codigo, String nombre, String email){
		super(); //Object()
		this.codigo = codigo;
		this.nombre = nombre;
		this.email = email;
	...
	*/
	...
	public Cliente2(int codigo, String nombre, String email, long telefono, boolean nuevo, double cifraVentas) {
		super(); 
		this.codigo = codigo;
		this.nombre = nombre;
		this.email = email;	
	...
	/**
	 * @return El numero de cifras de las ventas del cliente selecionado
	 */
